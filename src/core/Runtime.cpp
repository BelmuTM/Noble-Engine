...
int main() {
    ...
    objectManager.createObject("lucy.obj", {-1.0f, 1.0f, 1.50f}, {0.0f, 0.0f, -30.0f}, glm::vec3{0.0025f});
    objectManager.createObject("stanford_dragon.obj", {3.0f, 0.7f, 0.67f}, {0.0f, 180.0f, 60.0f}, glm::vec3{0.6f});
    ...
    objectManager.createObject("sponza_old.gltf", {0.0f, 0.0f, 0.0f}, {90.0f, 0.0f, 0.0f}, glm::vec3{0.01f});
